...
class ChnPassword:
    def __init__(self, frm, user):
        ...
        def clear():
            for i in [ent_cur_pass, ent_new_pass, ent_c_new_pass]:
                i.delete(0, END)
        ...
        def change_state(state):
            ...
            ent_c_new_pass.configure(state=state)
        ...
        lbl_new_pass = ttk.Label(self.frm, text="New password",
                                 font=('Helvetica', 12))
        lbl_c_new_pass = ttk.Label(self.frm, text="Confirm New password",
                                   font=('Helvetica', 12))
        ...
        lbl_new_pass.grid(row=4, column=0, padx=30,
                          pady=(15, 10), sticky=W)
        lbl_c_new_pass.grid(row=6, column=0, padx=30,
                            pady=(30, 10), sticky=W)
        ...
        ent_new_pass = ttk.Entry(self.frm, width=28,
                                 state='disabled')
        ent_c_new_pass = ttk.Entry(self.frm, width=28,
                                   state='disabled')
        ...
        ent_new_pass.grid(row=5, column=0, padx=(40, 10),
                          pady=(5, 0))
        ent_c_new_pass.grid(row=7, column=0, padx=(40, 10),
                            pady=(5, 0))
