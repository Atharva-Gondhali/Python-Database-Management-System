...
class Main:
	def __init__( self, win ):
		...
		workspace_frame = ttk.Frame( main_frame, borderwidth = 3, relief = GROOVE, 
			width = 640, height = 540 )
		account_frame = ttk.Frame( main_frame, borderwidth = 3, relief = GROOVE,
			height = 60 )
		...
		account_frame.grid( row = 0, column = 0, columnspan = 2, sticky = EW,
			padx = 15, pady = (15, 0))
